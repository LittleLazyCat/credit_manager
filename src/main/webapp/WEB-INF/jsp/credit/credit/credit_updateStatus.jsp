									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<select name="crStatus" class="form-control" required="required">
												...
												<option value="3" <c:if test="${credit.crStatus==3 }"> selected="selected"</c:if>>已签具间协议</option>
												<option value="4" <c:if test="${credit.crStatus==4 }"> selected="selected"</c:if>>已签服务合同</option>
												<option value="5" <c:if test="${credit.crStatus==5 }"> selected="selected"</c:if>>已签法律协议</option>
