				...
				"render" : function(data, type, row) {
					var html = htmlTpl.dropdown.prefix
		            	  ...
		            	  if(row.crStatus == 1 && row.isAudit == 1){
		            		  ...
		            		  html += '  <li><a href="agreement/saveAgree?creditId='+row.id+'&userId='+row.dealTeamName+'" data-msg="确定签订<居间服务协议(前期)>吗？" data-model="dialog" data-callback="refreshTable">上传<居间服务协议(前期)></a></li>'
